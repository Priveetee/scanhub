...
<!-- Modal backdrop - using button for better accessibility -->
<div 
...
>
  ...
  <!-- Modal container -->
  <div 
    class="w-full max-w-3xl bg-slate-900 border border-slate-700 rounded-lg shadow-2xl overflow-hidden max-h-[90vh] flex flex-col relative z-10"
